...
[[maybe_unused]] static auto make_sample_dag_non_extremal_ua_node_id() {
  MADAGStorage<> input_storage = MADAGStorage<>::EmptyDefault();
  auto dag = input_storage.View();
...
[[maybe_unused]] static auto make_sample_dag_maximal_node_id() {
  MADAGStorage<> input_storage = MADAGStorage<>::EmptyDefault();
  auto dag = input_storage.View();
  ...
  dag.AddEdge({edge_id++}, {0}, {9}, {1}).GetMutableEdgeMutations()[{1}] = {'G', 'A'};
...
[[maybe_unused]] static auto make_sample_dag_noncontiguous_node_id() {
  MADAGStorage<> input_storage = MADAGStorage<>::EmptyDefault();
  auto dag = input_storage.View();
