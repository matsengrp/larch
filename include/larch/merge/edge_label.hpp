/**
 * @brief Represents a labeled edge in a phylogenetic tree by storing parent and child
 * node labels.
 *
 * EdgeLabel is a lightweight container that uniquely identifies an edge in a tree
 * structure by storing its parent and child NodeLabel objects. It provides hashing
